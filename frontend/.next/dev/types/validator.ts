...
// Validate ../../../app/api/zones/config/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/zones/config">> = Specific
  const handler = {} as typeof import("../../../app/api/zones/config/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
